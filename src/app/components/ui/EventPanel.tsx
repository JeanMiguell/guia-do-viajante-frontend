  ...
  return (
    <>
      ...
      >
        ...
        {/* HEADER */}
        <div className="px-6 pt-2 md:pt-6 pb-2 flex justify-between items-start">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 pt-4 pb-10">
          ...
          {event.introText && (
            <div className="flex justify-center mb-6">
              <div className="bg-white border border-[#e5e0d6] rounded-2xl px-6 py-4 text-sm text-gray-600 leading-relaxed text-center shadow-sm max-w-[380px]">
                {event.introText}
              </div>
            </div>
          )}
                ...
                <div
                  ...
                  className={`
                    ...
                    ${locked
                      ...
                      : "bg-white border border-[#e5e0d6] hover:shadow-md hover:border-[#d6a84f] cursor-pointer"
                    }
                  `}
                >
